export const INDEX_ICON = 'indexIcons' // 首页图标
export const SPACE_ICON = 'spaceIcons' // 动态页面图标
export const INFO_ICON = 'infoIcons' // 个人中心图标
export const MY_ARTICLE_ICON = 'myArticleIcons' // 我的帖子图标
export const SEND_ICON = 'sendIcons' // 发送页面图标
